...
const IconDesc = () => {
    return (
        <React.Fragment>
            <section className="d-md-flex bg-black align-items-center justify-content-around text-center">
              <div className="mt-5 p-3 mb-5 hover">
                <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="white" class="bi bi-calendar2-heart" viewBox="0 0 16 16">
                ...
                <h4 class="text-white mt-3">Personalizados</h4>
                <p class="text-white">¡Realiza tus pedidos!</p>
              </div>
              <div className="mt-5 p-3 mb-5 hover">
                <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="white" class="bi bi-chat-left-heart" viewBox="0 0 16 16">
                <path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12ZM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2Z"/>
                <path d="M8 3.993c1.664-1.711 5.825 1.283 0 5.132-5.825-3.85-1.664-6.843 0-5.132Z"/>
                </svg>
                <h4 class="text-white mt-3">Clientes felices</h4>
                <p class="text-white">¡Revisa instagram!</p>
              </div>
              <div className="mt-5 p-3 mb-5 hover">
                <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="white" class="bi bi-envelope-paper-heart" viewBox="0 0 16 16">
                ...
                <h4 class="text-white mt-3">Especial</h4>
                <p class="text-white">Ideal para cualquier <br/> ocasión especial.</p>
              </div>
            </section>
        </React.Fragment>
    )
